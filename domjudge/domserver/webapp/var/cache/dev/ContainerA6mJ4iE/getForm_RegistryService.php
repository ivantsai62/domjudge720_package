...
include_once $this->targetDirs[4].'/lib/vendor/symfony/form/FormRegistryInterface.php';
include_once $this->targetDirs[4].'/lib/vendor/symfony/form/FormRegistry.php';
include_once $this->targetDirs[4].'/lib/vendor/symfony/form/FormExtensionInterface.php';
include_once $this->targetDirs[4].'/lib/vendor/symfony/form/Extension/DependencyInjection/DependencyInjectionExtension.php';
include_once $this->targetDirs[4].'/lib/vendor/symfony/form/ResolvedFormTypeFactoryInterface.php';
include_once $this->targetDirs[4].'/lib/vendor/symfony/form/Extension/DataCollector/Proxy/ResolvedTypeFactoryDataCollectorProxy.php';
include_once $this->targetDirs[4].'/lib/vendor/symfony/form/ResolvedFormTypeFactory.php';
