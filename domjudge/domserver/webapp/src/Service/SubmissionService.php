...
class SubmissionService
{
    ...
    const PROBLEM_RESULT_REMAP = [
        ...
        'PARTICIALLY_CORRECT' => 'PARTICIALLY_CORRECT'
    ];
    ...
    public function submitSolution(
        ...
        //重新載入contest tema 和 contestproblem 
        ...
        //進行scoreboardService的更新
        $this->scoreboardService->calculateScoreRow($contest, $team, $problem->getProblem(),true,true);
